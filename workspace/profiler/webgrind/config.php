...
class Webgrind_Config{
	...
	* If empty, will use system tmp folder or logs tmp
	*/
	static $storageDir = '';
	static $profilerDir = '/workspace/profiler/logs';
	...
	*/
	...
	/**
	* Regex that matches the trace files generated by logs
	*/
    static function xdebugOutputFormat() {
        $outputName = ini_get('logs.profiler_output_name');
	...
	*/
	static function xdebugOutputDir() {
		$dir = ini_get('logs.profiler_output_dir');
